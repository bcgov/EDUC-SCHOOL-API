...
/**
 * The type School api interceptor.
 *
 * @author Om
 */
@Component
public class SchoolAPIInterceptor implements HandlerInterceptor {

  /**
   * The constant log.
   */
  private static final Logger log = LoggerFactory.getLogger(SchoolAPIInterceptor.class);
